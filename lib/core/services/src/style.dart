...
abstract class CoreStyle {
  ...
  _addListeners() {
    ...
    alignmentContent.addListener(() => _styleModel.alignmentContent = alignmentContent.getAlignment);
  ...
  /// ```
  void padding({double? all, double? horizontal, double? vertical, double? top, double? bottom, double? left, double? right}) {
    _styleModel.padding =
        EdgeInsets.only(top: top ?? vertical ?? all ?? 0.0, bottom: bottom ?? vertical ?? all ?? 0.0, left: left ?? horizontal ?? all ?? 0.0, right: right ?? horizontal ?? all ?? 0.0);
  }
  ...
  /// ```
  void margin({double? all, double? horizontal, double? vertical, double? top, double? bottom, double? left, double? right}) {
    _styleModel.margin =
        EdgeInsets.only(top: top ?? vertical ?? all ?? 0.0, bottom: bottom ?? vertical ?? all ?? 0.0, left: left ?? horizontal ?? all ?? 0.0, right: right ?? horizontal ?? all ?? 0.0);
  }
  ...
  void linearGradient(
      {AlignmentGeometry begin = Alignment.centerLeft, AlignmentGeometry end = Alignment.centerRight, required List<Color> colors, TileMode tileMode = TileMode.clamp, List<double>? stops}) {
    _styleModel.gradient = LinearGradient(begin: begin, end: end, colors: colors, tileMode: tileMode, stops: stops);
  }

  /// Creates a radial gradient.
  ///
  /// The [colors] argument must not be null. If [stops] is non-null, it must have the same length as [colors].
  void radialGradient({AlignmentGeometry center = Alignment.center, required double radius, required List<Color> colors, TileMode tileMode = TileMode.clamp, List<double>? stops}) {
  ...
  void sweepGradient(
      {AlignmentGeometry center = Alignment.center, double startAngle = 0.0, required double endAngle, required List<Color> colors, TileMode tileMode = TileMode.clamp, List<double>? stops}) {
  ...
  void border({double? all, double? left, double? right, double? top, double? bottom, Color color = const Color(0xFF000000), BorderStyle style = BorderStyle.solid}) {
  ...
  void circle([enable = true]) => enable ? _styleModel.boxShape = BoxShape.circle : null;
  ...
  void boxShadow(
    ...
    double spread = 0.0,
      ...
      _styleModel.boxShadow = boxShadows ??
          [
            BoxShadow(
              color: color,
              blurRadius: blur,
  ...
  /// ```
  void elevation(double elevation, {double angle = 0.0, Color color = const Color(0x33000000), double opacity = 1.0}) {
    ...
    _styleModel.boxShadow = [BoxShadow(color: colorWithOpacity, blurRadius: elevation, spreadRadius: 0.0, offset: Offset(offsetX, offsetY))];
  }
  ...
  ///   ..rotate(0.75 * pi * 2)
  /// ```
  void rotate(double angle) => _styleModel.rotate = angleToRadians(angle, angleFormat);
...
class ParentStyle extends CoreStyle {
  ...
  /// ```
  void add(ParentStyle parentStyle, {bool override = false}) => _styleModel.inject(parentStyle._styleModel, override);
...
class TxtStyle extends CoreStyle {
  ...
  void textDirection(TextDirection textDirection) => _textModel.textDirection = textDirection;

  void textOverflow(TextOverflow textOverflow) => _textModel.textOverflow = textOverflow;

  void textShadow({Color color = const Color(0x33000000), double blur = 0.0, Offset offset = Offset.zero}) {
  ...
  /// ```
  void textElevation(double elevation, {double angle = 0.0, Color color = const Color(0x33000000), double opacity = 1.0}) {
    if (elevation == 0) return;
    ...
    _textModel.textShadow = [Shadow(color: colorWithOpacity, blurRadius: elevation, offset: Offset(offsetX, offsetY))];
  }
...
class Gestures {
  ...
  /// )
  /// ```
  Gestures({this.behavior, this.excludeFromSemantics = false, this.dragStartBehavior = DragStartBehavior.start})
      : gestureModel = GestureModel(behavior: behavior, excludeFromSemantics: excludeFromSemantics, dragStartBehavior: dragStartBehavior);
  ...
  void onTapDown(void Function(TapDownDetails) function) => gestureModel.onTapDown = function;
  ...
  void onLongPressStart(void Function(LongPressStartDetails) function) => gestureModel.onLongPressStart = function;

  void onLongPressEnd(void Function(LongPressEndDetails) function) => gestureModel.onLongPressEnd = function;

  void onLongPressMoveUpdate(void Function(LongPressMoveUpdateDetails) function) => gestureModel.onLongPressMoveUpdate = function;

  void onLongPressUp(void Function() function) => gestureModel.onLongPressUp = function;

  void onVerticalDragStart(void Function(DragStartDetails) function) => gestureModel.onVerticalDragStart = function;

  void onVerticalDragEnd(void Function(DragEndDetails) function) => gestureModel.onVerticalDragEnd = function;

  void onVerticalDragDown(void Function(DragDownDetails) function) => gestureModel.onVerticalDragDown = function;

  void onVerticalDragCancel(void Function() function) => gestureModel.onVerticalDragCancel = function;

  void onVerticalDragUpdate(void Function(DragUpdateDetails) function) => gestureModel.onVerticalDragUpdate = function;

  void onHorizontalDragStart(void Function(DragStartDetails) function) => gestureModel.onHorizontalDragStart = function;

  void onHorizontalDragEnd(void Function(DragEndDetails) function) => gestureModel.onHorizontalDragEnd = function;

  void onHorizontalDragDown(void Function(DragDownDetails) function) => gestureModel.onHorizontalDragDown = function;

  void onHorizontalDragCancel(void Function() function) => gestureModel.onHorizontalDragCancel = function;

  void onHorizontalDragUpdate(void Function(DragUpdateDetails) function) => gestureModel.onHorizontalDragUpdate = function;

  void onForcePressStart(void Function(ForcePressDetails) function) => gestureModel.onForcePressStart = function;

  void onForcePressEnd(void Function(ForcePressDetails) function) => gestureModel.onForcePressEnd = function;

  void onForcePressPeak(void Function(ForcePressDetails) function) => gestureModel.onForcePressPeak = function;

  void onForcePressUpdate(void Function(ForcePressDetails) function) => gestureModel.onForcePressUpdate = function;

  void onPanStart(void Function(DragStartDetails) function) => gestureModel.onPanStart = function;
  ...
  void onPanDown(void Function(DragDownDetails) function) => gestureModel.onPanDown = function;

  void onPanUpdate(void Function(DragUpdateDetails) function) => gestureModel.onPanUpdate = function;

  void onScaleStart(void Function(ScaleStartDetails) function) => gestureModel.onScaleStart = function;

  void onScaleEnd(void Function(ScaleEndDetails) function) => gestureModel.onScaleEnd = function;

  void onScaleUpdate(void Function(ScaleUpdateDetails) function) => gestureModel.onScaleUpdate = function;
